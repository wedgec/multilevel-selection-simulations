...
class EvolutionSimulator:
    ...
    # migrationFunction: function for managing migration of individuals from group to group,
        between rounds. Choose from functions defined in simulatation.migration, or create a custom function
    ...
    # toWriteColumnTitles: boolean, whether to write column titles to CSV file. Useful to specify as false
     ...
     # toPrintDataVecs: boolean, whether to print vectors of data at end of simulatation
    ...
    ***NOTE***: parameters regarding death are not specified in this implementation as
    ...
    # rounds: number of rounds of the simulatation
    ...
    # prefixParams: vector of numeric values that represent simulatation parameters. prefixParams 
    ...
    Public methods:
    # runEvolutionarySimulation(self): runs complete evolutionary simulatation given parameters specified
        in constructor
    '''
    ...
    def _prefixParams(self):    
        ...
        '''
        returns a vector numeric values represent the parameters/independent variables of the simulatation. These
        will prepend the vectors containing the dependent trial data. In this way the simulatation parameters
    ...
    def  runEvolutionarySimulation(self):
        ...
        '''
         Description: runs complete evolutionary simulatation. Works principally by running
